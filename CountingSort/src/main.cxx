...
int main()
{
    ...
    coordinates.FILL(coordinates.POSITIONS, coordinates.PARTICLE_AMOUNT, coordinates.RMAX,
                     ...
                     coordinates.Nz, coordinates.GRID_COUNT, coordinates.OFFSET, coordinates.IDS, coordinates.NN_COUNT, coordinates.NN_IDS, coordinates.NN_MAX);
    ...
    coordinates.KernelsEnqeue(coordinates.IDS, coordinates.Nx, coordinates.Ny, coordinates.Nz, coordinates.GRID_COUNT,
                              ...
                              coordinates.CELLSIZE, coordinates.NN_COUNT, coordinates.NN_IDS);
}
