...
void coordinate_math::first_three_cells(Dalele &particle, MAP_BOUNDS boundai){
    ...
    particle_coords[0]=boundai.MAP_BOUNDS_MAX[0]-(boundai.MAP_BOUNDS_MAX[0]/2)-1;
...
// 3D skaiciavimai ////////////
    ...
    rez_calc_d=(0.5)*(-dot_prod(vector_w, vector_t)+sqrt(pow(dot_prod(vector_w, vector_t),2)-4*rez_calc_c));
