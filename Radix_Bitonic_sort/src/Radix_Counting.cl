...
uint dRadixSum[TOTALRADIXGROUPS * RADICES];
uint gRadixBlockSum[PREFIX_NUM_BLOCKS];
uint dRadixBlockSum[PREFIX_NUM_BLOCKS];

extern __local uint sRadixSum[];
...
//!                  byte
////////////////////////////////////////////////////////////////////////////////
__kernel void RadixSum(KeyValuePair *pData, uint elements, uint elements_rounded_to_3072, uint shift)
{
...
//!                  byte
////////////////////////////////////////////////////////////////////////////////
__kernel void RadixAddOffsetsAndShuffle(KeyValuePair* pSrc, KeyValuePair* pDst, uint elements, uint elements_rounded_to_3072, int shift)
{
